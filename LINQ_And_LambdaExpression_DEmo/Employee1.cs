        ...
        public static List<Employee1> GetEmployees()
        {
            List<Employee1> Employee1s = new List<Employee1>()
            {
                new Employee1 {ID = 101, Name = "Preety", Gender = "Female", Salary = 60000,
                              Technology = new List<string>() {"C#", "Java", "C++"} },
                ...
                new Employee1 {ID = 105, Name = "Sambit", Gender = "Male", Salary = 55000},
                new Employee1 {ID = 106, Name = "Sushanta", Gender = "Male", Salary = 70000,
